...
import { VersionedTransactionResponse, AddressLookupTableAccount, MessageAccountKeys, MessageAddressTableLookup, RpcResponseAndContext, PublicKey, Connection } from "@solana/web3.js";
...
export async function resolveAccounts({transaction, version}: VersionedTransactionResponse, connection: Connection): Promise<Result<MessageAccountKeys, ResolveAccountsError>> {
